...
geneticSettings = {
        ...
        'weights_convulation': {
            ...
            #'wd1': (4*4*128,128) ,#('W3', shape=(4*4*128,128), initializer=tf.contrib.layers.xavier_initializer()),
            'wc4': (3,3,16,32),
            'wc5': (3,3,32,64),
            'wc6': (3,3,64,128),
            'wc7': (3,3,128,256),
        ...
        'biases': {
            # 'bc1': 32 ,#('B0', shape=(32), initializer=tf.contrib.layers.xavier_initializer()),
            # 'bc2': 64 ,#('B1', shape=(64), initializer=tf.contrib.layers.xavier_initializer()),
            # 'bc3': 128 ,#('B2', shape=(128), initializer=tf.contrib.layers.xavier_initializer()),
            # 'bd1': 128 ,#('B3', shape=(128), initializer=tf.contrib.layers.xavier_initializer()),
            # 'out': 10 ,#('B4', shape=(10), initializer=tf.contrib.layers.xavier_initializer()),
            'bc1': (2),
            'bc2': (4),
            'bc3': (16),
            'bc4': (32),
