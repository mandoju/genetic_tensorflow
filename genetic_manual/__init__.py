...
def mutation(neural_networks,population_size,mutationRate):
    #depois fazer matrix mascara (a.k.a recomendação do tio gabs)
...
if __name__ == "__main__":
    ...
    new_neural_weights = crossover(best_ones,50);