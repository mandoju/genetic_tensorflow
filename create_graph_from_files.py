...
plt.show()
 ...
 """
#files_pickle = ['./graphs/20_he_menor.pckl','./graphs/40_he_menor.pckl','./graphs/80_he_menor.pckl','./graphs/160_he_menor.pckl','./graphs/gradient.pckl']
files_pickle = ['./graphs/40_3.pckl','./graphs/gradient_3.pckl']
...
graph = plt.plot(graphs[0].tempo,graphs[0].performance , '-', label="Mutation_20")
gradient = plt.plot(graphs[1].tempo,graphs[1].performance , '-', label="Mutation_20")
